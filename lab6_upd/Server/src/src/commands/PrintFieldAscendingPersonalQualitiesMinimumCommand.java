 ...
 */
public class PrintFieldAscendingPersonalQualitiesMinimumCommand implements Command, CommandClient, Serializable {
    ...
    public String execute(String argument) {
        try {
            ...
            Stream<String> stream = collectionManager.getLabWorkVector().stream()
